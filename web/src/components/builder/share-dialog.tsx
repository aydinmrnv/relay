      ...
      <div className="flex flex-col gap-4">
        <ul className="flex flex-col gap-2 text-sm text-muted-foreground">
          <li className="flex gap-2">
            <Lock className="mt-0.5 size-4 shrink-0 text-primary" /> Secrets in node settings, allowlisted logins and your repository name are removed from the public copy.
          </li>
          <li className="flex gap-2">
